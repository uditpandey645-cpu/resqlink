  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        sos:
          "gradient-danger text-primary-foreground shadow-xl glow-danger hover:opacity-90 active:scale-[0.98] font-bold uppercase tracking-wider",
        safe:
          "gradient-safe text-safe-foreground shadow-xl glow-safe hover:opacity-90 active:scale-[0.98] font-semibold",
        glass:
          "glass text-foreground hover:bg-secondary/60 active:scale-[0.98]",
      },
      size: {
